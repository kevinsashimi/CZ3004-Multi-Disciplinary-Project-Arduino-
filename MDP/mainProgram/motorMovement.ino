...
volatile double Kp=20, Ki=80, Kd=0; //Set PID values //Previous adjusted PID values: Kp=23, Ki=80, Kd=0.02 (When weight is one RPi and 2 powerbanks given PID values: Kp=30, Ki=80, Kd=0.02)
...
void backward(double gridNumber){
  ...
  double totalSteps = totalRegularSteps(gridNumber * 8.9);
